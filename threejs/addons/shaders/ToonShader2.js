...
const ToonShaderHatchingGreen = {
	...
	uniforms: {
		...
		'uBaseColor': { value: new Color( 0xffffff ) },
		'uLineColor1': { value: new Color( 0x7d9e13 ) },
		'uLineColor2': { value: new Color( 0x7d9e13 ) },
		'uLineColor3': { value: new Color( 0x7d9e13 ) },
		'uLineColor4': { value: new Color( 0x7d9e13 ) }
...
export { ToonShader1, ToonShader2, ToonShaderHatching, ToonShaderDotted, ToonShaderHatchingGreen };
