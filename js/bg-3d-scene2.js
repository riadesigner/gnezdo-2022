...
// import { ToonShader1, ToonShader2, ToonShaderHatching, ToonShaderDotted, ToonShaderHatchingGreen } from 'three/addons/shaders/ToonShader2.js';
import { ToonShaderHatchingGreen } from 'three/addons/shaders/ToonShader2.js';
...
function init() {
	...
	container = document.getElementById( 'content-3d' );
	var size = {width:$('#content-3d').width(),height:$('#content-3d').height()};

	// CAMERA
	camera = new THREE.PerspectiveCamera( 45, window.innerWidth / window.innerHeight, 1, 10000 );
	// camera = new THREE.PerspectiveCamera( 45, size.w / size.height, 1, 10000 );
	...
	// SETTING PARAMS FOR DIFFERENT SIZE OF WINDOW
	setParamsForDifferentSizesOfWindow();
...
function setParamsForDifferentSizesOfWindow(){
	// scene.rotation.y = 44;
	scene.rotation.z = 10;
...
function generateMaterials() {
	...
	const hatchingMaterial = createShaderMaterial( ToonShaderHatchingGreen, light, ambientLight );
